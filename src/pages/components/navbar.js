            ...
            <div className="max-[640px]:w-full max-sm:h-[6rem] h-[8rem] sm:w-full w-full flex flex-col justify-center items-center">
                ...
                sm:max-lg:w-[24rem] sm:max-lg:h-[4rem] "> 
                    <div className="h-full w-full  flex  flex-col justify-center items-center">
                        <Link href={navBar[1].path} className="text-black">{navBar[1].place}</Link>
                    </div>
                    <div className="h-full  w-full flex  flex-col justify-center items-center">
                    <Link href={navBar[0].path} className="text-black">{navBar[0].place}</Link>
                    </div>
                    <div className="h-full w-full  flex  flex-col justify-center items-center">
                    <Link href={navBar[2].path} className="text-black">{navBar[2].place}</Link>
                    </div>
                </div> 
